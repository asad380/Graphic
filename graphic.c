...
#include<iomanip.h>
	...
	void checkl()       		// LINEAR EQUATION VERIFICATION
	{
...
cout << "\n\tYour Equation\t: y = " << a << "(x^2) + " << b << "(x^1) + " << c <<" \n\n\n";
	...
	void checkq() 		// QUADRATIC EQUATION VERIFICATION
	{
...
cout << "\n\tYour Equation\t: y = " << a << "(x^3) + " << b << "(x^2) + " << c << "(x^1) + " << d << "\n\n\n" ;
	...
	void checkc()							// CUBIC EQUATION VERIFICATION
	{
...
cout << "    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n\n" ;
		...
		float x,y;
			...
			if(l.a==0)       			   // LINEAR EQUATION VERIFICATION
			{
				l.checkl();
			goto main ;

			}
	output << "\n\n\n				Your Equation\t: y = " << l.a << "(x^1) + " << l.b << "\n\tZOOM-OUT FOR BETTER VIEW OF CURVE \n\n\n" ;
			float nsize = (-1*size) ;
...
cout << "    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n" ;
			...
			if(q.a==0) 				 // QUADRATIC EQUATION VERIFICATION
			{
				q.checkq();
			goto main ;
			}

output << "\n\n\n				Your Equation : y = " << q.a << "(x^2) + " << q.b << "(x^1) + " << q.c <<"\n\tZOOM-OUT FOR BETTER VIEW OF CURVE \n\n\n" ;
			float nsize = (-1*size) ;
...
cout << "    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n" ;
			...
			if(u.a==0)				// CUBIC EQUATION VERIFICATION
			{
				u.checkc();
			goto main ;
			}

output << "\n\n\n Your Equation : y = " << u.a << "(x^3) + " << u.b << "(x^2) + " << u.c << "(x^1) + " << u.d << "\n\tZOOM-OUT FOR BETTER VIEW OF CURVE \n\n\n" ;
			float nsize = (-1*size) ;
			for(x=nsize; x<=size; x+=0.5)
			{
				y = (u.a*x*x*x) + (u.b*x*x) + (u.c*x) + u.d ;
...
read_me << "<h3 style=\"background-color:skyblue;\"  align =\"center\"> A Program By Dhaiwat Kabaria</h3>\n  " ;
...
read_me << "<P>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp*&nbsp&nbsp&nbsp&nbsp&nbspDOSBox\n   " ;
		...
		clrscr() ;
			...
			cout << "\n" ; for( loop=0; loop<80; loop++)	cout <<"\f" ;
			cout << "\n\n\n\n\n\n\n\n\n\n\n\n\n\n" ;
			cout << "\n\t\tMade by Asad Mansuri \t Class:Xll B" ;
			cout << "\n" ; for( loop=0; loop<80; loop++)	cout <<"\f" ;
			cout << "\n¸¸.¤°¨°¤¸¸.¤°¨°¤¸¸.¤°¨°¤¸¸.¤°¨°¤¸¸.¤°¨°¤¸¸.¤°¨°¤¸¸.¤°¨°¤¸¸.¤°¨°¤¸¸.¤°¨°¤¸¸.¤°¨°¤" ;
			getch() ;
			clrscr() ;
